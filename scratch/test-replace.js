...
try {
  ...
  // Define some replacements in the XML
  // We can do direct regex replacements on the text tags
  
  // 1. Client header info
  // Let's find <w:t>@@@@@@@@</w:t> and replace with client Name and Address
  // Let's replace the first few occurrences
  let count = 0;
